...
public class BuatPesananRequest extends StringRequest {
    ...
    private static String URLCash = "http://192.168.43.61:8080/invoice/createCashInvoice";
    private static String URLCashless = "http://192.168.43.61:8080/invoice/createCashlessInvoice";
